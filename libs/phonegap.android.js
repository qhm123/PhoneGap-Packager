...
/* alarm plugin */
sina.alarm = {
  start : function(triggerAtTime, interval, callbackUrl, callbackFuctionName, inexact) {
    cordova.exec(null, null, 'Alarm', 'start', [triggerAtTime, interval, callbackUrl, callbackFuctionName, inexact]);
  },
  stop : function() {
    cordova.exec(null, null, 'Alarm', 'stop', []);
  }
};
