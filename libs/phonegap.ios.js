// SAE update version 2.0 @2012.07.26 by liulei10@
...
/**
 * sina.sms plugin
 * iOS just support 'send'
 * 'get','remove','insert' return error reason.
 */
sina.sms = {
...
/*
 * check app version and update 
 */
sina.updater = {
    check : function(successCallback,errorCallback){
        cordova.exec(successCallback,errorCallback,'CheckUpdate','check',[]);
    }
};
